...
namespace GRANSAC
{
    ...
    public:
        ...
        virtual std::pair<VPFloat, std::vector<std::shared_ptr<AbstractParameter>>> Evaluate(const std::vector<std::shared_ptr<AbstractParameter>> &EvaluateParams, VPFloat Threshold, VPFloat min_val, VPFloat max_val) = 0;
