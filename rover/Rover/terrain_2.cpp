...
int test2(Mat pic1, Mat pic2) {
	...
	Mat img_object = pic2; // imread("D:\\SO\\img\\box.png", CV_LOAD_IMAGE_GRAYSCALE);
	Mat img_scene = pic1; // imread("D:\\SO\\img\\box_in_scene.png", CV_LOAD_IMAGE_GRAYSCALE);
	...
	Ptr<DescriptorExtractor> extractor = ORB::create("ORB");
